    ...
    return (
        <Container>
            <Helmet>
                ...
                <meta name="description" content="Итальянский бренд Diesel создаёт авангардные fashion-часы с выраженным футуристичным акцентом в дизайне. Нестандартная величина 
                    корпуса и броские, провокационные элементы циферблата делают часы бренда ярчайшей деталью имиджа. Компания экспериментирует и с техническим наполнением: в линейке 
                    часов Diesel присутствуют, к примеру, модели с несколькими механизмами. Отточенный стиль сочетается с функциональностью и надёжностью, необходимыми для активного ритма 
                    жизни."/>
                <meta name="keywords" content="купить мужские часы Diesel в Алматы, купить наручные часы Diesel в Алматы, купить часы Diesel в Казахстане, 
