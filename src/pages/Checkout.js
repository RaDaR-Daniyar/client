...
const isValid = (input) => {
    ...
    switch (input.name) {
        ...
        case 'phone':
            ...
            return pattern.test(input.value.trim())
        case 'address' : return input.value.trim() !== ''
    }
}
        ...
        <Container>
            ...
            <Form noValidate onSubmit={handleSubmit}>
                <Form.Control
                    ...
                    placeholder="Введите имя и фамилию... (Формат ввода Имя Фамилия)"
                    className="mb-3"
                />
                <Form.Control
                    name="email"
                    ...
                    placeholder="Введите адрес почты... (Формат ввода test@test.kz)"
                    className="mb-3"
                />
                <Form.Control
                    name="phone"
                    ...
                    placeholder="Введите номер телефона...(Формат ввода +7 (777) 777-77-77)"
                    className="mb-3"
                />
                <Form.Control
                    name="address"
                    ...
                    placeholder="Введите адрес доставки... (Формат ввода г. Тест, ул. Тест, д. 7, кв.7)"
                    className="mb-3"
                />
                <Form.Control
                    name="comment"
