...
const EditStrap = (props) => {
    ...
    const handleSubmit = (event) => {
        ...
        if (correct) {
            ...
            id ? updateStrap(id, data).then(success).catch(error) : createStrap(data).then(success).catch(error)
        }
    }
            ...
            <Modal.Body>
                <Form noValidate onSubmit={handleSubmit}>
                    <Form.Control
                        ...
                        placeholder="Название материала браслета/ремешка..."
                        className="mb-3"
                    />
