    ...
    return (
        <Container>
            <Helmet>
                ...
                <meta name="description" content="Авторизованный сервисный центр «SWService» — это команда профессиональных мастеров по ремонту часов. Мастера производят 
                    обслуживание и ремонт на самом высоком уровне, который соответствует всем стандартам заводов изготовителей. Оснащённый самым современным оборудованием 
                    и инструментом, что позволяет более точно проводить диагностику и исправление поломок. Все оборудование и инструменты были изготовлены в специализированных 
                    компаниях Швейцарии и Германии. Для контроля качества ежегодно проводится проверка квалификации сотрудников. В 
                ...
                <meta name="keywords" content="купить японские наручные часы в Алматы, купить швейарские наручные часы в Алматы, наручные часы в Алматы, часы в Алматы,
                    ...
                    Швейцарские армейские ножи и столовые приборы Victorinox, сервис центр часов, официальный сервис центр швейцарскмх часов и японских часов" />
            </Helmet>
                ...
                <p><b>Условия гарантийного обслуживания:</b>
                    <ul>
                        <li style={{textAlign: 'justify'}}>
                            Гарантийный срок на продукцию составляет от 12 месяцев и более со дня продажи. Настоящая гарантия действительна в случае предъявления правильно заполненного 
